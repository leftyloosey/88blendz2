...
const Body = () => {
  return (
    <div>
      <section id='hero' className='rounded-[120px]'>
        <div class='container flex flex-col-reverse mx-auto p-6 lg:flex-row'>
          <div class='flex flex-col space-y-10 mb-44 lg:mt-16 lg:w-1/2 xl:mb-52'>
            <h4 class='text-4xl text-white font-bold text-center lg:text-6xl lg:max-w-md lg:text-left'>
            ...
            <div class='mx-auto lg:mx-0'>
              <a
                href={blendLink}
                class='py-5 px-10 text-2xl duration-500 font-bold text-white bg-[#552583] rounded-full lg:py-4 hover:brightness-105 hover:text-[#FDB927]'
              >
                Book
              </a>
            </div>
